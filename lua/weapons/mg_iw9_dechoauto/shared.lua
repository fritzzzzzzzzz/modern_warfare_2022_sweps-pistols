...
if CLIENT then
    killicon.Add( "mg_iw9_dechoauto", "VGUI/entities/mg_iw9_dechoauto", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/spawnicons/icon_iw9_dechoauto")
end
