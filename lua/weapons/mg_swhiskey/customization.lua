...
SWEP.Customization = {
    ...
    {"att_perk", "att_vm_pi_swhiskey_soh", "att_perk_fmj", "att_perk_ricochet", "att_perk_fastswap"},

    {"att_receiver"},
	
    {"att_trigger_swhiskey", "attachment_vm_pi_swhiskey_hairtrigg", "attachment_vm_pi_swhiskey_hvytrigg", "att_vm_p26_pi_swhiskey_triglight_v0"},
	
	{"attachment_vm_pi_swhiskey_ammo", "attachment_vm_pi_swhiskey_loader_snake"},
	
    {"attachment_vm_pi_swhiskey_pistgrip", "attachment_vm_pi_swhiskey_pistgripstdy", "attachment_vm_pi_swhiskey_pistgriptac", "attachment_vm_pi_swhiskey_pistgripass"},

    {"attachment_vm_pi_swhiskey_mag","attachment_vm_pi_swhiskey_lightmag","attachment_vm_pi_swhiskey_hvymag", },
	
	{"attachment_vm_pi_swhiskey_cylinder"},
    
    {"att_muzzle", "att_vm_p26_pi_swhiskey_comp01_v0", "att_vm_p26_pi_swhiskey_brake01_v0", "att_vm_p26_pi_swhiskey_brake02_v0"},
    ...
    "att_vm_reflex_east02", "att_vm_reflex_west02_tall", "att_vm_reflex_west03", "att_vm_p26_pi_swhiskey_scope_v0"},

    {"att_vm_pi_swhiskey_barrel", "att_vm_pi_swhiskey_barhvylong", "att_vm_pi_swhiskey_barrel_long", "att_vm_pi_swhiskey_barmini", "att_vm_pi_swhiskey_barlight", "att_vm_pi_swhiskey_barshort"},
