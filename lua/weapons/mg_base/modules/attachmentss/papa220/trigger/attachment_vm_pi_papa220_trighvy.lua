...
ATTACHMENT.Name = "XRX Heavy V3 Trigger"
ATTACHMENT.Model = Model("models/kyo/att_vm_p27_pi_papa220_trighvy_v0_lod0.mdl")
ATTACHMENT.Icon = Material("models/kyo/icon/p220/icon_hvytrig.vmt")
