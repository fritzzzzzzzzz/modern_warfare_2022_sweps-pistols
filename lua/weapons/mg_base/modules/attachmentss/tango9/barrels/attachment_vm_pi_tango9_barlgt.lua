...
ATTACHMENT.Name = "Streetweeper 9mm"
ATTACHMENT.Model = Model("models/kyo/att_vm_p49_pi_tango9_barlgt_v0_lod0.mdl")
ATTACHMENT.Icon = Material("models/icon/tango9/icon_attachment_p49_pi_tango9_barlgt_v0.vmt")
