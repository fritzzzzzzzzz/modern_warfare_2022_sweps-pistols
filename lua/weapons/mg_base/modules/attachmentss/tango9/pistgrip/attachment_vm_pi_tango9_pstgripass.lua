...
ATTACHMENT.Name = "FTAC Stead"
ATTACHMENT.Model = Model("models/kyo/att_vm_p49_pi_tango9_pgripass_v0_lod0.mdl")
ATTACHMENT.Icon = Material("models/icon/tango9/icon_attachment_p49_pi_tango9_pgripass_v0.vmt")
