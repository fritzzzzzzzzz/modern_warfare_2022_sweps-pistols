...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("ps_wfoly_plr_pi_tango9_sup_plr")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
...
SWEP.Customization = {
    ...
    {"att_perk", "attachment_vm_pi_tango9_perk_soh", "att_perk_fmj", "att_perk_ricochet", "att_perk_fastswap"},
    ...
    "att_vm_silencer01_pstl", "att_vm_silencer02_pstl", "att_vm_silencer04_pstl", "att_vm_oil_filter_suppressor", "att_vm_breacher01", "att_vm_breacher02", "att_vm_compensator01", 
    ...
    {"att_grip", "attachment_vm_pi_tango9_vertgripext", "attachment_vm_pi_tango9_vertgrip", "attachment_vm_pi_tango9_angledgrip"},

    {"att_laser", "att_vm_pi_tango9_laser01", "att_vm_pi_tango9_laser02", "att_vm_pi_tango9_laser03"}
}
