...
if CLIENT then
    killicon.Add( "mg_iw9_tango9", "VGUI/entities/mg_iw9_tango9", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/entities/mg_tango9_icon")
end
SWEP.GripPoseParameters = {"grip_gripang_offset", "grip_gripvert_offset", "grip_gripvertext_offset"}
SWEP.Base = "mg_base"
...
SWEP.Spawnable = true
SWEP.VModel = Model("models/fritz/weapons/tango9/v_tango9.mdl")
SWEP.WorldModel = Model("models/fritz/weapons/tango9/w_tango9.mdl")
SWEP.Trigger = {
...
SWEP.Primary.Sound = Sound("ps_wfoly_plr_pi_tango9_fire_plr")
...
SWEP.Purpose = "Designed to be compact and maneuverable, this SMG has a jaw-dropping fire rate and rapid swap speed. A trusted secondary for up-close engagements."
...
SWEP.Cone = {  
    ...
    AdsMultiplier = 0.3, --multiply the increase value by this amount while aiming
    ...
    Seed = 994121 --just give this a random number 
}

SWEP.Recoil = {
    Vertical = {0.6, 1.7}, --random value between the 2
...
SWEP.Bullet = {
    Damage = {24, 13}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range
