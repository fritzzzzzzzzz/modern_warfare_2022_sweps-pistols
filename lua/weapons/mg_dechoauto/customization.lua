...
function SWEP:doSuppressorStats()
    self.Primary.Sound = Sound("decho_mwii_fire_sup")
    self.Reverb = {
        RoomScale = 50000,
        Sounds = {
            Outside = {
                Layer = Sound("decho_mwii_atmo_out_sup"),
                Reflection = Sound("Reflection_ARSUP.Outside")
            },
    
            Inside = { 
                Layer = Sound("decho_mwii_atmo_in_sup"),
...
function SWEP:doPhantomFooorceStyle()
    self.Primary.Sound = Sound("PF_DEAG_FIRE")

end

SWEP.Customization = {

    {"att_perk", "att_vm_p25_pi_decho_perk_soh", "att_perk_fmj", "att_perk_ricochet", "att_perk_fastswap"},

    {"att_vm_p25_pi_dechoauto_mag_v0", "att_vm_p25_pi_decho_xmag_v0", "att_vm_p25_pi_decho_xmaglrg_v0"},

    {"att_vm_p25_pi_dechoauto_rec_v0"},
	
    {"att_grip", "att_vm_p25_pi_decho_stubbygrip01", "att_vm_p25_pi_decho_stubbygrip02"},

    {"att_muzzle", "att_vm_p25_pi_decho_brake01_v0", "att_vm_p25_pi_decho_brake02_v0", "att_vm_p25_pi_decho_comp01_v0",
    "att_vm_p25_pi_decho_comp02_v0", "att_vm_p25_pi_decho_flash_v0", "att_vm_p25_pi_decho_silencer_v0"},

    {"att_sight", "att_vm_p25_pi_decho_laser_iron", "att_vm_minireddot01_tall", "att_vm_minireddot02_tall", "att_vm_minireddot03_tall", "att_vm_holo_west02", "att_vm_holo_east01", "att_vm_reflex_east01",
    "att_vm_reflex_east02", "att_vm_reflex_west02_tall", "att_vm_reflex_west03",
    "att_vm_4x_east01", "att_vm_4x_west01", "att_vm_holo_west01"},

    {"att_vm_p25_pi_dechoauto_grip_v0", "att_vm_p25_pi_decho_gripaim_v0", "att_vm_p25_pi_decho_gripass_v0", "att_vm_p25_pi_decho_griptac_v0"},

    {"att_vm_p25_pi_dechoauto_barrel_v0", "att_vm_p25_pi_decho_barlight_v0", "att_vm_p25_pi_decho_barlong_v0", "att_vm_p25_pi_decho_barhvy_v0", "att_vm_p25_pi_decho_barhvylong_v0"},

    {"att_vm_p25_pi_dechoauto_trig_v0"},
