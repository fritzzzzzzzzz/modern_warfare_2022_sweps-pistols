...
if CLIENT then
    killicon.Add( "mg_vm_pl_papa220", "VGUI/entities/mg_vm_pl_papa220", Color(255, 0, 0, 255))
...
SWEP.Spawnable = true
SWEP.VModel = Model("models/kyo/v_papa220.mdl")
SWEP.WorldModel = Model("models/kyo/w_papa220.mdl")
SWEP.Trigger = {
