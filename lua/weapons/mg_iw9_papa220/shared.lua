...
if CLIENT then
    killicon.Add( "mg_iw9_papa220", "VGUI/entities/mg_iw9_papa220", Color(255, 0, 0, 255))
    SWEP.WepSelectIcon = surface.GetTextureID("VGUI/entities/mg_p220_icon")
end
...
SWEP.Spawnable = true
SWEP.VModel = Model("models/fritz/weapons/papa220/v_papa220.mdl")
SWEP.WorldModel = Model("models/fritz/weapons/papa220/w_papa220.mdl")
SWEP.Trigger = {
...
SWEP.Purpose = "For close-quarters situations, the P890 semi-auto pistol takes advantage of accuracy, reliability, and a hard-hitting .45 Auto round. Subsonic Ammo hides kill skulls from the enemy team."
...
SWEP.Bullet = {
    Damage = {39, 28}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range
...
SWEP.Shell = "mwb_shelleject_iw9_45acp"