...
if CLIENT then
    killicon.Add( "mg_iw9_golf17", "VGUI/entities/mg_iw9_golf17", Color(255, 0, 0, 255))
...
SWEP.Spawnable = true
SWEP.VModel = Model("models/easy/mw/weapons/vm_iw9_golf17.mdl")
SWEP.WorldModel = Model("models/easy/mw/weapons/wm_iw9_golf17.mdl")
SWEP.Trigger = {
