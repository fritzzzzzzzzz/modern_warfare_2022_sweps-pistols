...
if CLIENT then
    killicon.Add( "mg_decho_mwii", "VGUI/entities/mg_decho_mwii", Color(255, 0, 0, 255))
...
SWEP.Primary.RPM = 163
SWEP.CanChamberRound = true
SWEP.Purpose = "A powerful semi-automatic pistol. Control the recoil and the .50 cal rounds will do the rest."
SWEP.FreezeInspectDelta = 0.25
...
SWEP.Bullet = {
    Damage = {69, 38}, --first value is damage at 0 meters from impact, second value is damage at furthest point in effective range
